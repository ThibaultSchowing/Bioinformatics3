...
class GenericNetwork:
    ...
    def build_edges(self):
        ...
        # build a list of sets, each set is an edge
        list_of_edges = []
        duplicates = []
        for parent_node in self.nodes.keys():
            duplicates.append(parent_node)
            for child_node in self.nodes[parent_node].neighbour_nodes:
                if child_node not in duplicates:
                    list_of_edges.append({parent_node, child_node})
