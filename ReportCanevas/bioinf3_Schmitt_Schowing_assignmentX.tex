...
\author{Thibault Schowing and Wiebke Schmitt}


\usepackage{fancyhdr,graphicx,lastpage}% http://ctan.org/pkg/{fancyhdr,graphicx,lastpage}
\fancypagestyle{plain}{
	\fancyhf{}% Clear header/footer
	\fancyhead[R]{Thibault Schowing and Wiebke Schmitt}% Right header
	\fancyhead[L]{Bioinformatics III}% Left footer
...
\begin{document}	
	...
	\begin{titlepage}
		...
		\small\textit{Wiebke \textsc{Schmitt} Mat. 2543675}\par
