...
%\begin{table}[H]
%	\centering
%	\caption{Up Regulated Proteins}
%	\label{my-label}
%	\begin{tabular}{|l|l|l|l|}
%		\hline
%		Protein                                                                                                        & Gene ID & Fold Change & Gene name \\ \hline
%		\begin{tabular}[c]{@{}l@{}}Protein kinase C-binding\\ protein 1\end{tabular}                                   & 1117    & 3.074       & ZMYND8    \\ \hline
%		\begin{tabular}[c]{@{}l@{}}Tropomyosin alpha-1\\ chain\end{tabular}                                            & 2078    & 3.776       & TPM1      \\ \hline
%		\begin{tabular}[c]{@{}l@{}}Eukaryotic peptide\\ chain release factor GTP\\ -binding subunit ERF3A\end{tabular} & 2182    & 3.003       & GSPT1     \\ \hline
%		Syntenin-1                                                                                                     & 1489    & 8.613       & SDCBP     \\ \hline
%		\begin{tabular}[c]{@{}l@{}}Specle targeted \\ PIP5K1A-regulated poly\\ (A) plymerase\end{tabular}              & 1116    & 3.206       & TUT1      \\ \hline
%		\begin{tabular}[c]{@{}l@{}}Vacuolar protin sorting-\\ associated protein 28 \\ homolog\end{tabular}            & 1018    & 2.263       & VPS28     \\ \hline
%		\begin{tabular}[c]{@{}l@{}}Engulfment and cell\\ mobility protein 2\end{tabular}                               & 344     & 2.345       & ELMO2     \\ \hline
%		\begin{tabular}[c]{@{}l@{}}Ribonucleoside-diphosphate\\ reductase subunit M2\end{tabular}                      & 2411    & 3.011       & RRM2      \\ \hline
%		\begin{tabular}[c]{@{}l@{}}Charged multivesicular\\ body protein 1a\end{tabular}                               & 1226    & 2.286       & CHMP1A    \\ \hline
%		Tuftelin                                                                                                       & 82      & 2.649       & TUFT1     \\ \hline
%	\end{tabular}
%\end{table}
%	
...
\begin{figure}[H]
	...
	\caption{Graph of the results of a SAM analysis with parameters fdr.output = 0.2 and nperms = 100 with the first set of rna. The Delta value is 0.24, letting many genes marked as over- or under-expressed. }
	\label{fig:rplot}
\end{figure}
